...
variable "private_network" {
  description = "Self link to the network we want to peer with the DB"
  type = string
}

variable "require_ssl" {
  description = "Configure whatever the connection must go through SSL (default: true)"
  default = true
}

variable "public_ip" {
  description = "Configure whatever the database will be assigned a public IP (default: false)"
  type = bool
  default = false
}

variable "authorized_networks" {
  description = "Authorized network to connect to the instance."
  type = list
  default = []
}
